                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full rounded-md border border-gray-300 px-3 py-2 pr-10 text-sm focus:outline-none focus:border-[#0E8B42] focus:ring-1 focus:ring-[#0E8B42]"
                        />
                        <button
                          type="button"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-md border border-gray-300 px-3 py-2 pr-10 text-sm focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPasswords(!showPasswords)}
